...
In earlier labs and earlier in the quarter, even at midterm portfolio, I was still not able to accomplish learning targets efficiently. However, as shown throughout all of specifically lab 8, I have accomplished the 3 aspects of portraying the use of modern tools, with the correct syntax, and with what we have learned from class. For example, I have shown this in PE-2 both in example 1 and example 2. I have also took the time to revise every lab to ensure that I am grasping the concepts correctly.
